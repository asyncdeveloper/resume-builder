module.exports = ({
      name, email, phone , country , city,  headline ,
    ...
    return `
       <!DOCTYPE html>
        <html>
            ...
            <link href='http//fonts.googleapis.com/css?family=Rokkitt400,700|Lato:400,300' rel='stylesheet' type='text/css'>
            ...
            <body id="top">
                ...
                <h2 class="quickFade delayThree">${jobTitle}</h2>
                </div>
                
                <div id="contactDetails" class="quickFade delayFour">
                <ul>
                <li>c: ${city} , ${country}</li>
                <li>m: ${phone}</li>
                <li>e: ${email}</li>
                </ul>
                </div>
                ...
                <div class="sectionContent">
                <article>
                <h2>${jobTitle} at ${jobCompany}</h2>
                <p class="subDetails">${jobStart} - ${jobEnd}</p>
                <p>${JobDesc}</p>
                </article>
